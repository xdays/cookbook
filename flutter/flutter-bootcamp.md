...
State Challenge(Ask Me Anything)
...
# How to Use Flutter and Dart Packages to Sppeed up Development
    ...
    setState(() {
      if (quizBrain.isFinished() == true) {
        Alert(
          context: context,
          title: 'Finished!',
          desc: 'You reach the end of this quiz.',
        ).show();
        quizBrain.reset();
        scoreKeeper = [];
      } else {
...
# Building UI with Flutter for Itermediates

BMI Calculator Project

https://github.com/xdays/bmi_calculator

# Powering Your Flutter Project with Live Web Data
...
https://github.com/xdays/clima_app

Bitcoin Ticker

https://github.com/xdays/crypto_ticker
...
https://github.com/xdays/flash_chat
